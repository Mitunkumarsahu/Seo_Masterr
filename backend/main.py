...
app.include_router(testimonial.router, prefix=API_PREFIX)
app.include_router(social_media.router, prefix=API_PREFIX)
app.include_router(home_feature.router, prefix=API_PREFIX)
app.include_router(faq.router, prefix=API_PREFIX)
app.include_router(best_works.router, prefix=API_PREFIX)
app.include_router(why_choose_us.router, prefix=API_PREFIX)
app.include_router(process_step.router, prefix=API_PREFIX)
app.include_router(about_hero.router, prefix=API_PREFIX)
app.include_router(contact_hero.router, prefix=API_PREFIX)
