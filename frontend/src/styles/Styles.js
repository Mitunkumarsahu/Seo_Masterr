...
const style = {
  ...
  homeAboutSection: {
    wrapper: {
      ...
      overflow: "hidden",
      position: "relative",
      background: "linear-gradient(135deg, #1e3a8a 0%, #0a2b4c 100%)",
    ...
    leftSection: {
      ...
      "@keyframes colorFlow": {
        "0%, 100%": { background: "linear-gradient(180deg, #10b981 0%, #059669 50%, #047857 100%)" },
        "50%": { background: "linear-gradient(180deg, #047857 0%, #10b981 50%, #34d399 100%)" },
      },
    },
    title: {
      ...
      lineHeight: 1.1,
      mb: 3,
      background: "linear-gradient(135deg, #1e3a8a 0%, #0a2b4c 50%, #0284c7 100%)",
      backgroundClip: "text",
      WebkitBackgroundClip: "text",
      WebkitTextFillColor: "transparent",
      position: "relative",
    ...
    rightSection: {
      ...
      "&::after": {
        ...
        width: "100px",
        height: "100px",
        background: "linear-gradient(45deg, rgba(16, 185, 129, 0.3) 0%, rgba(5, 150, 105, 0.3) 100%)",
        borderRadius: "50%",
        filter: "blur(40px)",
  ...
  testimonialSection: {
    ...
    headline: {
      ...
      position: "relative",
      zIndex: 2,
      background: "linear-gradient(135deg, #1e3a8a 0%, #0a2b4c 50%, #10b981 100%)",
      backgroundClip: "text",
      WebkitBackgroundClip: "text",
      WebkitTextFillColor: "transparent",
      ...
      "&::before": {
        ...
        fontSize: "32px",
        animation: "testimonialBounce 2s ease-in-out infinite",
      },
      "&::after": {
        content: '""',
        position: "absolute",
        ...
        background: "linear-gradient(90deg, #10b981 0%, #059669 50%, #047857 100%)",
        borderRadius: "2px",
        animation: "testimonialLineGrow 1s ease-out 0.5s both",
      },
